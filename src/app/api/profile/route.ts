    ...
    if (profileId) {
      const profile = await prisma.profile.findFirst({
        ...
        include: {
          ...
          ethnicity: { select: { id: true, name: true } },
          caste: { select: { id: true, name: true } },
          ...
          maslak: { select: { id: true, name: true } },
          height: { select: { id: true, display: true } },
          educationLevel: { select: { id: true, name: true } },
          educationField: { select: { id: true, name: true } },
          incomeRange: { select: { id: true, display: true } },
